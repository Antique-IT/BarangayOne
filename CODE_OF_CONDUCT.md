...
If you experience or witness unacceptable behavior, report it through the channels listed in [SUPPORT.md](SUPPORT.md).

All reports will be reviewed and investigated promptly and fairly.

## Enforcement Guidelines

Maintainers may follow these response levels:

1. **Correction**: Clarify behavior and request change.
2. **Warning**: Formal warning for repeated or serious issues.
3. **Temporary Ban**: Time-limited removal from participation.
4. **Permanent Ban**: Removal for severe or repeated violations.
